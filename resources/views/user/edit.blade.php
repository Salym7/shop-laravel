    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="{{route('user.update', $user->id)}}" method='post'>
                ...
                <div class="form-group">
                    <input type="text" value="{{$user->surname ?? old('surname')}}" name='surname' class="form-control"
                        placeholder="surname">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" value="{{$user->address ?? old('address')}}" name='address' class="form-control"
                        placeholder="address">
                </div>
                <div class="form-group">
                    <select name="gender" class="custom-select form-control" id="exampleSelectBorder">
                        <option disabled selected>Gender</option>
                        <option {{$user->gender == 1 || old('gender')==1 ? ' selected' : ' ' }} value="1">Men</option>
                        <option {{$user->gender == 2 ||old('gender')==2 ? ' selected' : ' ' }} value="2">Women</option>
                    </select>
                </div>
                <div class="form-group ">
